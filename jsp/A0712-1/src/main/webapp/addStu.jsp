...
<form action="MemberJoinProc.jsp" method="post">
    ...
    <tr height="50">
        ...
        <td width="350" align="center"><input type="password" name="pass" size="40" placeholder="비밀번호는 영문자만 넣어주세요"></td>
    ...
    <tr height="50">
        ...
        <td width="350" align="center"><input type="text" name="addr" size="40"></td>
